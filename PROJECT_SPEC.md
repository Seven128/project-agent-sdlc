...
7. **Check Evidence** is typed, current-execution behavior evidence for declared Claims and Assertions, bound to the declared scenario, journey role, execution target, production surface binding and Evidence Capabilities when those semantics apply.
