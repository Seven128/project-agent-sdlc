...
function actualObservation(artifactPath, hashes, identity, sensitivity) {
  return {
    artifact_path: artifactPath,
    artifact_sha256: hashes[artifactPath],
    locator: { kind: "json_pointer", value: `/observations/${identity}` },
    value_sha256: fixtureSha(`observation:${identity}`),
    sensitivity,
    redaction:
...
function comparisonResult(artifactPath, hashes, identity, comparison) {
  return {
    artifact_path: artifactPath,
    artifact_sha256: hashes[artifactPath],
    locator: { kind: "json_pointer", value: `/comparisons/${identity}` },
    result_sha256: fixtureSha(`comparison:${identity}`),
