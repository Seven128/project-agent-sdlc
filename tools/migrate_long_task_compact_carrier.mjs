...
const compactSource = createSemanticFactCompactCarrier(sourceRow.manifest);
const sourceBody = YAML.stringify(JSON.parse(JSON.stringify(compactSource)), {
  lineWidth: 0,
  indentSeq: false,
...
const compactContract = createLongTaskCompactContract(
  contract,
  sourceRow.fact_revisions,
  sourceRow.obligation_revisions,
);
