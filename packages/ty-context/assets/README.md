...
npm install -D /path/to/project-tiny-context-harness/tmp/ty-context/source-preview/package/project-tiny-context-harness-0.8.15.tgz
...
`npm run preview:pack` produces a local preview named `project-tiny-context-harness-0.8.15.tgz` under the preview output directory.
