export const DESIGN_RESOURCE_RECOVERY_INPUT_SCHEMA =
  "design-resource-recovery-input-v4" as const;
export const DESIGN_RESOURCE_RECOVERY_SCHEMA =
  "design-resource-recovery-checkpoint-v4" as const;
