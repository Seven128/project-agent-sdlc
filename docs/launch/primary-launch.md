...
This is the copy-ready launch packet for the first public push after `project-tiny-context-harness@0.8.15` is published.
...
- npm `project-tiny-context-harness@0.8.15` is published and installable.
- The `v0.8.15` GitHub Release is published from [github-release-0.8.15.md](github-release-0.8.15.md); future npm Trusted Publishing real runs create or update this release automatically after publish.
