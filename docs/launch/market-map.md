...
| GitHub release | Latest release is `Project Tiny Context Harness 0.8.11` |
| npm package | `project-tiny-context-harness@0.8.11` is published and installable through `@latest` |
