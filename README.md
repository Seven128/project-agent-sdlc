...
### 5.2 阶段契约
阶段契约写在 `.harness/policies/phase_contracts.yaml`。核心关系如下：
...
3. 按 `.harness/templates/CHECKPOINT_TEMPLATE.md` 写 checkpoint。
...
```txt
.harness/overrides/skills/<skill-name>.md
.harness/overrides/templates/<template-name>.md
