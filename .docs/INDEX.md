...
| 测试 | `.docs/07_test/` | Test report、test matrix、回归证据、覆盖缺口 | [MVP package release test report](07_test/TEST_REPORT.md), [Harness consumer lab validation](07_test/harness_consumer_lab.md) |
