...
| 测试 | `.docs/07_test/` | Test plan、test matrix、回归记录 | [MVP package release test plan](07_test/TEST_PLAN.md), [Harness consumer lab validation](07_test/harness_consumer_lab.md) |
