...
3. [npm_package/dev_001_package_scaffold.md](npm_package/dev_001_package_scaffold.md)
4. [npm_package/dev_002_sync_init_doctor.md](npm_package/dev_002_sync_init_doctor.md)
5. [npm_package/dev_003_upgrade_migrations.md](npm_package/dev_003_upgrade_migrations.md)
6. [npm_package/dev_004_source_sync_ci.md](npm_package/dev_004_source_sync_ci.md)
7. [npm_package/dev_005_validate_commands.md](npm_package/dev_005_validate_commands.md)
8. [npm_package/dev_006_unified_harness_root.md](npm_package/dev_006_unified_harness_root.md)
9. [npm_package/dev_007_remove_tracked_agents_skills.md](npm_package/dev_007_remove_tracked_agents_skills.md)
10. [npm_package/dev_008_configurable_harness_root.md](npm_package/dev_008_configurable_harness_root.md)
11. [npm_package/dev_009_init_prompt_default_agent_root.md](npm_package/dev_009_init_prompt_default_agent_root.md)
12. [npm_package/dev_010_task_checkpoint_model.md](npm_package/dev_010_task_checkpoint_model.md)
13. [npm_package/dev_011_plan_yaml_no_checkpoint.md](npm_package/dev_011_plan_yaml_no_checkpoint.md)
14. [npm_package/dev_012_makefile_include_block.md](npm_package/dev_012_makefile_include_block.md)
15. [npm_package/dev_013_package_workspace_decoupling_principle.md](npm_package/dev_013_package_workspace_decoupling_principle.md)
16. [npm_package/dev_014_authoring_overlay_design.md](npm_package/dev_014_authoring_overlay_design.md)
17. [npm_package/dev_015_markdown_doc_overviews.md](npm_package/dev_015_markdown_doc_overviews.md)
18. [npm_package/dev_016_role_prompts_and_karpathy_guidelines.md](npm_package/dev_016_role_prompts_and_karpathy_guidelines.md)
19. [npm_package/dev_017_chinese_karpathy_guidelines.md](npm_package/dev_017_chinese_karpathy_guidelines.md)
20. [npm_package/dev_018_task_commit_push_rule.md](npm_package/dev_018_task_commit_push_rule.md)
21. [npm_package/dev_019_commit_before_task_compression.md](npm_package/dev_019_commit_before_task_compression.md)
22. [npm_package/dev_020_rename_npm_package.md](npm_package/dev_020_rename_npm_package.md)
23. [npm_package/dev_021_consolidate_managed_config.md](npm_package/dev_021_consolidate_managed_config.md)
24. [npm_package/dev_022_pjsdlc_marker_prefix.md](npm_package/dev_022_pjsdlc_marker_prefix.md)
25. [npm_package/dev_023_pjsdlc_layout_and_skill_prefix.md](npm_package/dev_023_pjsdlc_layout_and_skill_prefix.md)
26. [npm_package/dev_024_done_task_git_history_lookup.md](npm_package/dev_024_done_task_git_history_lookup.md)
27. [npm_package/dev_025_short_lived_plan_and_gate_log.md](npm_package/dev_025_short_lived_plan_and_gate_log.md)
28. [npm_package/dev_026_remove_execution_history_from_active_state.md](npm_package/dev_026_remove_execution_history_from_active_state.md)
29. [npm_package/dev_027_workflow_singleton_collaboration_boundary.md](npm_package/dev_027_workflow_singleton_collaboration_boundary.md)
30. [npm_package/dev_028_remove_gate_results_state_and_rfc_impact.md](npm_package/dev_028_remove_gate_results_state_and_rfc_impact.md)
31. [npm_package/dev_029_natural_language_control.md](npm_package/dev_029_natural_language_control.md)
32. [npm_package/dev_030_readme_user_guide.md](npm_package/dev_030_readme_user_guide.md)
33. [npm_package/package_release_flow.md](npm_package/package_release_flow.md)
...
## npm_package/dev_025_short_lived_plan_and_gate_log.md

Source: [npm_package/dev_025_short_lived_plan_and_gate_log.md](npm_package/dev_025_short_lived_plan_and_gate_log.md)
...
## npm_package/dev_026_remove_execution_history_from_active_state.md

Source: [npm_package/dev_026_remove_execution_history_from_active_state.md](npm_package/dev_026_remove_execution_history_from_active_state.md)
...
## npm_package/dev_027_workflow_singleton_collaboration_boundary.md

Source: [npm_package/dev_027_workflow_singleton_collaboration_boundary.md](npm_package/dev_027_workflow_singleton_collaboration_boundary.md)
...
## npm_package/dev_028_remove_gate_results_state_and_rfc_impact.md

Source: [npm_package/dev_028_remove_gate_results_state_and_rfc_impact.md](npm_package/dev_028_remove_gate_results_state_and_rfc_impact.md)
...
## npm_package/dev_029_natural_language_control.md

Source: [npm_package/dev_029_natural_language_control.md](npm_package/dev_029_natural_language_control.md)
...
## npm_package/dev_030_readme_user_guide.md

Source: [npm_package/dev_030_readme_user_guide.md](npm_package/dev_030_readme_user_guide.md)
...
## npm_package/package_release_flow.md

Source: [npm_package/package_release_flow.md](npm_package/package_release_flow.md)
...
- Updated by task: `DEV-033`, `DEV-035`
- Linked PRD: `.docs/01_product/npm_package_distribution.md`
- Linked technical design: `.docs/03_tech_plan/harness_package_distribution.md`
- Linked RFC: none
...
- 新增（Added）:
  ...
  - `tools/release_npm.mjs` release automation script.
  - `agent-project-sdlc@0.1.4` release record generated by the script.
- 修改（Changed）:
  ...
  - `packages/sdlc-harness/package.json` and `package-lock.json` version bumped from `0.1.3` to `0.1.4`.
  - Root `package.json` now exposes `npm run release:npm`.
- 未覆盖（Not covered）:
  - Release script does not create git commits, tags, or pushes; SPRINTING task protocol still owns implementation commit and completion ledger commit.
...
| `package.json` | root workspace scripts | `scripts.release:npm` |
| `tools/release_npm.mjs` | release automation entrypoint | version resolution, gate runner, npm publish, registry smoke, release doc writer |
...
| `.docs/08_release/v0.1.4_npm_release.md` | script-generated release evidence and rollback plan | Build Artifacts, Smoke Test Result, Deployment Checklist |
...
-> npm pack dry run with JSON evidence
-> npm publish when --publish --yes is explicit
-> npm view latest verification
-> install published package in temp consumer
-> init + doctor smoke
-> write release doc
-> refresh docs overview
-> final harness / allowed_paths / diff gates
-> git tag and push
```

## 5. 关键实现逻辑

- 输入校验（Input validation）: 脚本从本地 package version 和 npm registry latest 解析目标版本；真正 publish 必须显式传入 `--publish --yes`。
- 核心分支（Core branches）: 默认 dry-run 只准备 release；publish 模式执行 `npm publish --workspace agent-project-sdlc`，触发 workspace package 的 `prepack`，由 TypeScript build 生成 tarball 内的 `dist/**`。
- 异常处理（Error handling）: 如果 publish 前 gate 失败，不发布；如果 publish 后 smoke 失败，不能复用版本号，只能修复后发布下一个 patch。
- 边界兜底（Boundary fallback）: release doc 保留 rollback plan，消费者可临时固定上一稳定版本。
...
| `npm pack --dry-run --json --workspace agent-project-sdlc` | tarball contents and package metadata | PASS |
...
| `node --check tools/release_npm.mjs` | release automation script syntax | PASS |
| `python3 tools/validate_allowed_paths.py` | changed files within active DEV task allowed_paths | PASS |
...
| 2026-05-25 | `DEV-035` | `DEV-035` implementation commit | 新增 release automation script，并用脚本发布 `agent-project-sdlc@0.1.4`。 |
