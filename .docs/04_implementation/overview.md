...
25. [npm_package/dev_025_short_lived_plan_and_gate_log.md](npm_package/dev_025_short_lived_plan_and_gate_log.md)
26. [npm_package/dev_026_remove_execution_history_from_active_state.md](npm_package/dev_026_remove_execution_history_from_active_state.md)
27. [npm_package/dev_027_workflow_singleton_collaboration_boundary.md](npm_package/dev_027_workflow_singleton_collaboration_boundary.md)
28. [npm_package/dev_028_remove_gate_results_state_and_rfc_impact.md](npm_package/dev_028_remove_gate_results_state_and_rfc_impact.md)
29. [npm_package/dev_029_natural_language_control.md](npm_package/dev_029_natural_language_control.md)
