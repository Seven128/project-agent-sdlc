...
3. [v0.1.11_npm_release.md](v0.1.11_npm_release.md)
4. [v0.1.12_npm_release.md](v0.1.12_npm_release.md)
5. [v0.1.1_npm_release.md](v0.1.1_npm_release.md)
6. [v0.1.2_npm_release.md](v0.1.2_npm_release.md)
7. [v0.1.3_npm_release.md](v0.1.3_npm_release.md)
8. [v0.1.4_npm_release.md](v0.1.4_npm_release.md)
9. [v0.1.5_npm_release.md](v0.1.5_npm_release.md)
10. [v0.1.6_npm_release.md](v0.1.6_npm_release.md)
11. [v0.1.7_npm_release.md](v0.1.7_npm_release.md)
12. [v0.1.8_npm_release.md](v0.1.8_npm_release.md)
13. [v0.1.9_npm_release.md](v0.1.9_npm_release.md)
...
## v0.1.11_npm_release.md

Source: [v0.1.11_npm_release.md](v0.1.11_npm_release.md)

# Release Note And Rollback Plan（发布说明与回滚方案）

## 1. Release Summary（发布摘要）

- Version: `agent-project-sdlc@0.1.11`
- Milestone: `MVP`
- Date: `2026-05-27`
- Owner: `release_manager`
- Registry: `https://registry.npmjs.org/`
...
| 产物（Artifact） | 位置（Location） | Checksum/Version |
|---|---|---|
| npm package | `agent-project-sdlc` | `0.1.11` |
| dry-run tarball | `npm pack --dry-run --json --workspace agent-project-sdlc` | `59d3019d26e62bb154952e8a0f8e2e2965c9eab8` |
| dry-run integrity | same | `sha512-Dyl90XlSoNaQpNarcBAVPCy5MC5gh+oQ2rBsOsNjO0VY83z3f3Ic/kHIEbO+pxviKa0LR9cV17OHFa+RkJ4nXQ==` |
| package content | dry-run output | 83 files, 58.8 kB package size, 208.4 kB unpacked size |
| registry package | `npm view agent-project-sdlc version dist-tags.latest dist.integrity --json` | `version 0.1.11`, `latest 0.1.11`, `integrity sha512-Dyl90XlSoNaQpNarcBAVPCy5MC5gh+oQ2rBsOsNjO0VY83z3f3Ic/kHIEbO+pxviKa0LR9cV17OHFa+RkJ4nXQ==` |
...
- Evidence:
  ...
  - `npm pack --dry-run --json --workspace agent-project-sdlc`: PASS。
  - `git diff --check`: PASS。
  - `npm publish --workspace agent-project-sdlc`: PASS，registry 返回 agent-project-sdlc@0.1.11。
  - `npm view agent-project-sdlc version dist-tags.latest dist.integrity --json`: PASS，version 和 latest 均为 0.1.11。
  - Registry installed-consumer smoke: PASS，从 npm registry 安装 agent-project-sdlc@0.1.11 后，init 和 doctor 均通过，doctor 输出 `core package: agent-project-sdlc@0.1.11`。

## 5. Deployment Checklist（部署检查清单）

- [x] Confirm registry latest before publishing.
- [x] Bump package version to `0.1.11`.
- [x] Package source drift check passed.
- [x] npm tests passed.
- [x] Pack dry run passed.
- [x] Publish package with `npm publish --workspace agent-project-sdlc`.
- [x] Verify registry package with `npm view agent-project-sdlc version dist-tags.latest dist.integrity --json`.
- [x] Run installed-consumer smoke from npm registry.
- [x] Create and push git tag `v0.1.11` after publish success.
...
## v0.1.12_npm_release.md

Source: [v0.1.12_npm_release.md](v0.1.12_npm_release.md)

# Release Note And Rollback Plan（发布说明与回滚方案）

## 1. Release Summary（发布摘要）

- Version: `agent-project-sdlc@0.1.12`
- Milestone: `MVP`
- Date: `2026-05-28`
- Owner: `release_manager`
- Registry: `https://registry.npmjs.org/`
...
| 产物（Artifact） | 位置（Location） | Checksum/Version |
|---|---|---|
| npm package | `agent-project-sdlc` | `0.1.12` |
| dry-run tarball | `npm pack --dry-run --json --workspace agent-project-sdlc` | `b2a5364ffab9d345b308c5157db8d46b72722eeb` |
| dry-run integrity | same | `sha512-n9qC3m1gwaQAUbf52s2Z0Nzuo65GrNBh91sxC1oT0CjEX9rONX1pqPk05W3MIwm48CF0zb9TcpXwneO2L097CA==` |
| package content | dry-run output | 83 files, 61.6 kB package size, 216.8 kB unpacked size |
| registry package | `npm view agent-project-sdlc version dist-tags.latest dist.integrity --json` | `version 0.1.12`, `latest 0.1.12`, `integrity sha512-n9qC3m1gwaQAUbf52s2Z0Nzuo65GrNBh91sxC1oT0CjEX9rONX1pqPk05W3MIwm48CF0zb9TcpXwneO2L097CA==` |
...
- Evidence:
  ...
  - `npm pack --dry-run --json --workspace agent-project-sdlc`: PASS。
  - `git diff --check`: PASS。
  - `npm publish --workspace agent-project-sdlc`: PASS，registry 返回 agent-project-sdlc@0.1.12。
  - `npm view agent-project-sdlc version dist-tags.latest dist.integrity --json`: PASS，version 和 latest 均为 0.1.12。
  - Registry installed-consumer smoke: PASS，从 npm registry 安装 agent-project-sdlc@0.1.12 后，init 和 doctor 均通过，doctor 输出 `core package: agent-project-sdlc@0.1.12`。

## 5. Deployment Checklist（部署检查清单）

- [x] Confirm registry latest before publishing.
- [x] Bump package version to `0.1.12`.
- [x] Package source drift check passed.
- [x] npm tests passed.
- [x] Pack dry run passed.
- [x] Publish package with `npm publish --workspace agent-project-sdlc`.
- [x] Verify registry package with `npm view agent-project-sdlc version dist-tags.latest dist.integrity --json`.
- [x] Run installed-consumer smoke from npm registry.
- [x] Create and push git tag `v0.1.12` after publish success.
