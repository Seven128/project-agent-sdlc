...
One set-valued certificate may cover multiple Rule identities, omitted axes and dependency edges. Admission separately reports semantic-obligation count, certificate-obligation count, exact covered omitted-axis/dependency-edge sets and counts, canonical DAG nodes/edges/bytes and theoretical cardinality. The package recomputes dependence, region/digest identity and certificate coverage; a declaration or provider `complete` flag proves nothing. Canonical work and obligation/certificate representation stay bounded independently of theoretical ground cardinality and never use sampling, granularity reduction or expand-then-deduplicate.
